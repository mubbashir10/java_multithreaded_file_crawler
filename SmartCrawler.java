            ...
            for ( File f : list ) {
                ...
                if ( f.isDirectory() ){
                    ...
                    try{
                        ...
                        String query = "INSERT INTO data VALUES ('"+i+"','"+f.getName()+"','"+f.getAbsolutePath()+"','"+f.listFiles().length+"', 'N/A')";
                ...
                //file
                    ...
                    try{
                        ...
                        Statement statement = db.connection.createStatement();
                        String query = "INSERT INTO data VALUES ('"+i+"','"+f.getName()+"','"+f.getAbsolutePath()+"','0','N/A')";
                        statement.executeUpdate(query);
                    }
                    catch(SQLException exception){
                        ...
                        try{
                            ...
                            for (String s: tmpData) {   
                                ...
                                try{
                                    ...
                                    Statement statement = db.connection.createStatement();
                                    String query = "INSERT INTO data VALUES ('"+i+"','"+s+"','"+f.getAbsolutePath()+"','0','"+content+"')";
                                    statement.executeUpdate(query);
                                }
                                catch(SQLException exception){
